...
//         <div className={s.card_container}>
//           {checked === 'user'
//             ? dispayeduser.map((item, index) => (
//                 <Card
//                   key={`user-${index}`} // Add the key prop here
//                   name={item.name}
//                   ids={adminfeatures.findIndex((element) => element === item)}
//                   img_logo={item.link}
//                 />
//               ))
//             : dispayedadmin.map((item, index) => (
//                 <Card
//                   key={`admin-${index}`} // Add the key prop here
//                   name={item.name}
//                   ids={userfeatures.findIndex((element) => element === item)}
//                   img_logo={item.link}
//                 />
...
//   return (
//     <div className={`${s.card} ${ids}`} id={ids}>
//       <Image src={img_logo} alt="" width={60} height={60}></Image> {/* Add the alt prop */}
//       <h4>{name}</h4>
//     </div>
//   );
// };
