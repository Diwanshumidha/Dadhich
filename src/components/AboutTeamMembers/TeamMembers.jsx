...
//         }}
//         modules={[Autoplay]}
//         className={`team-carousel2 owl owl-carousel owl-none owl-theme owl-dots-primary-full ${c.teamCarousel}`}
//       >
//         <SwiperSlide
//           className={`item wow fadeInUp ${c.slide}`}
//           data-wow-duration="2s"
//           data-wow-delay="0.1s"
//         >
//           <div className="dlab-team style-2 m-b10">
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="dlab-team style-2 m-b10  riz">
            <div className="dlab-media">
              <img src="images/team/small/Rakesh1.jpeg" alt="Rakesh1.jpeg" />
            </div>
            <div className="dlab-content">
...
<SwiperSlide
  ...
  data-wow-delay="0.2s"
>
  <div className="dlab-team style-2 m-b10 divImg">
    <div
