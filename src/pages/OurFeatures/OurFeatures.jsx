							...
							<div className="row">
								<div className="col-lg-12 col-md-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
									<div className="icon-bx-wraper left m-b50 icon-up">
										...
										<div className="icon-content">
											<h4 className="dlab-tilte text-capitalize">Professional Results
											</h4>
											<p>Exceeding expectations with professional web development that delivers exceptional results.
											</p>
										</div>
									</div>
								</div>
								<div className="col-lg-12 col-md-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
									<div className="icon-bx-wraper left m-b50 icon-up">
										...
										<div className="icon-content">
											<h4 className="dlab-tilte text-capitalize">Cost Efficiency
											</h4>
											<p>Maximize your budget with our web development agency's cost-efficient solutions.
											</p>
										</div>
									</div>
								</div>
							...
							<div className="row">
								<div className="col-lg-12 col-md-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
									<div className="icon-bx-wraper left m-b50 icon-up">
										...
										<div className="icon-content">
											<h4 className="dlab-tilte text-capitalize">Custom Solutions
											</h4>
											<p>
												Personalized web development solutions tailored to match your distinct vision and goals.
											</p>
										</div>
									</div>
								</div>
								<div className="col-lg-12 col-md-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
									<div className="icon-bx-wraper left m-b50 icon-up">
										...
										<div className="icon-content">
											<h4 className="dlab-tilte text-capitalize" >Technical Support
											</h4>
											<p id="portfolio">Reliable technical assistance available to ensure smooth operation and optimal performance.</p>
										</div>
									</div>
								</div>
							</div>
